    ...
    <v-layout class="background">
      <div class="psycho-finish">
          <div class="finish-title">
              <span>스마트폰 중독 테스트 결과</span>
          </div>
          <div class="finish-img">
            <img v-if="answer < 4" src="/image/phone/1.png"> 
            <img v-else-if="answer > 3 && answer < 7" src="image/phone/2.png"> 
            <img v-else src="image/phone/3.png"> 
          ...
          <div class="result-text">
                    ...
                    <span v-if="answer < 4" style="color:green; font-weight: bold;"> 일반 사용자 </span>
                    <span v-else-if="answer > 3 && answer < 7" style="color:orange; font-weight: bold;"> 위험 사용자 </span>
                    <span v-else style="color:red; font-weight: bold;"> 중독 </span>
              입니다.
          </div>
