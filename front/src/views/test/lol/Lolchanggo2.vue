...
export default {
  ...
  return {
    ...
    score: 0,
    current:0,
    videoList:["/videos/ahri.mp4","/videos/yone.mp4","/videos/ezreal.mp4","/videos/zyra.mp4"],//"/videos/ahri.mp4","/videos/yone.mp4","/videos/ezreal.mp4","/videos/zyra.mp4"
